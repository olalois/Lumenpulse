...
export const WalletProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const connect = useCallback(async () => {
    ...
    return new Promise<void>((resolve) => {
      Alert.alert('Connect Wallet', 'Choose wallet connection method:', [
        {
          text: 'Cancel',
          style: 'cancel',
          onPress: () => {
        ...
        },
        {
          ...
          onPress: async () => {
            ...
            if (canOpen) {
              ...
              Alert.alert(
                'No Wallet Found',
                'Could not find a Stellar wallet supporting SEP-0007 deep links.',
              );
  ...
  const signAndSubmitXdr = useCallback(
    async (
      ...
      return new Promise((resolve) => {
        Alert.alert('Sign Transaction', 'A transaction requires your signature.', [
          {
            text: 'Reject',
            style: 'cancel',
            onPress: () => {
